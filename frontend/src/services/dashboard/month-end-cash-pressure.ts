...
export async function getDashboardMonthEndCashPressure(): Promise<DashboardMonthEndCashPressureResponse> {
  let response: Response;

  try {
    response = await fetch(dashboardMonthEndCashPressurePath(), {
      method: 'GET',
      credentials: 'include',
