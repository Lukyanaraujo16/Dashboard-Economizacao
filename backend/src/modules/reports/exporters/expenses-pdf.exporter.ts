...
export async function renderExpensesReportPdf(context: ExpensesExportContext): Promise<Buffer> {
  ...
  return renderSharedReportPdf({
    ...
    kpis: [
      ...
      { label: 'Pago', value: formatMoneyPtBr(report.payables.paid) },
    ...
    composition: {
      ...
      columns: [
        ...
        { header: 'Pago', width: 72, align: 'right' },
        { header: 'A pagar', width: 72, align: 'right' },
    ...
    monthly: {
      title: 'Despesas por mês de competência',
      columns: [
        { header: 'Mês', width: 90, align: 'left' },
        { header: 'Despesas', width: 82, align: 'right' },
        { header: 'Pago', width: 82, align: 'right' },
